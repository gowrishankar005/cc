...
**Status (updated 2026-08-20):** T-RT-1 and T-RT-2 done — see `Claim_Register.md`'s
`T-RT-1-bulk-residual-authoring` and `T-RT-2-consequence-ranked-queue` rows for
evidence and honest scope limits. T-RT-3/T-RT-4 not started.
