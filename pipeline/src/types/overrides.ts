...
export interface DecisionRecord {
  ...
  final_decision: {
    ...
    // real pilot sessions (3/3 residuals in both a reference Java/JAX-RS
    // banking platform and a reference Python microservices banking app
    // runs) — worth stating explicitly rather than leaving an
